...
// v4 — modal opacity +10% (rgba 0.35→0.45); persists to Supabase platform_bugs table.
(function () {
  console.log('[bug-fab] v4 loaded');
  ...
  function inject(db, email) {
    ...
    css.textContent = `
      ...
      .gb-content{background:rgba(20,15,10,0.45);border:1px solid rgba(255,255,255,0.08);border-radius:18px;padding:.85rem;width:100%;max-width:440px;box-shadow:0 12px 40px rgba(0,0,0,0.5);display:flex;flex-direction:column;gap:.55rem;margin:auto;}
